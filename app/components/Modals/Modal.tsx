...
import { BsX, BsFacebook } from 'react-icons/bs'
    ...
    return (
        ...
        >
            <div className='relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto'>
                ...
                >
                    <div className="translate h-full lg:h-auto md:h-auto border-0 md:rounded-lg shadow-lg
                        relative flex flex-col w-full bg-white outline-none focus:outline-none"
                    >
                        {/* header */}
                        <div className='flex items-center justify-center p-6 relative rounded-t border-b-[1px]'>
                            <button
